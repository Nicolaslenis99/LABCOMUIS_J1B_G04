...
from practica4 import practica4  # grc-generated hier_block
...
class practica4_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(0, 100000, 1, 50, 200)
        ...
        self._Ac_range = Range(0, 100, 1, 50, 200)
        ...
        self.practica4_0 = practica4(
            Ac=0.1,
            Kp=1,
        )

        self.top_layout.addWidget(self.practica4_0)
        self._kp_range = Range(0, 100, 1, 50, 200)
        ...
        self._fm_range = Range(0, 10000, 1, 50, 200)
        ...
        self._Am_range = Range(0, 100, 1, 50, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.practica4_0, 0))
        self.connect((self.practica4_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.practica4_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.practica4_0, 0), (self.uhd_usrp_sink_0, 0))
