...
class practica2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica2")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(0, 100, 1, 50, 200)
        ...
        self._A_range = Range(0, 100, 1, 50, 200)
...
def main(top_block_cls=practica2, options=None):
